    ...
    public function store(NewsStoreRequest $request)
    {
        ...
        while (true) {
            ...
            if ($count2>0) {
                ...
                $data=array('title' => request('title'), 'slug' => $slug, 'summary' => request('summary'), 'content' => request('content'), 'video' => request('video'), 'featured' => request('featured'), 'comment' => request('comments'), 'state' => request('state'), 'user_id' => Auth::user()->id);
                break;
            }
        }
