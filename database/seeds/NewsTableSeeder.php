...
class NewsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $news = [
        	['id' => 1, 'image' => 'noticia3de5.png', 'title' => 'El Universitario FC anuncia el compromiso del entrenador Carlos Marín Lópezes', 'slug' => 'el-universitario-fc-anuncia-el-compromiso-del-entrenador-carlos-marin-lopezes', 'summary' => $summary, 'content' => $content, 'video' => 'https://www.youtube.com/watch?v=Y-NeVAOkMlI', 'featured' => '1', 'comment' => '1', 'state' => '1', 'user_id' => 1, 'created_at' => Carbon\Carbon::create(2020, 07, 02)],
        	['id' => 2, 'image' => 'noticia5de5.png', 'title' => 'Una nueva Generación de Campeones', 'slug' => 'una-nueva-generacion-de-campeones', 'summary' => $summary, 'content' => $content, 'video' => 'https://www.youtube.com/watch?v=Y-NeVAOkMlI', 'featured' => '1', 'comment' => '1', 'state' => '1', 'user_id' => 1, 'created_at' => Carbon\Carbon::create(2020, 07, 03)],
        	['id' => 3, 'image' => 'noticia2de5.png', 'title' => 'El Nápoles, festeja y va directo a la Final de la Copa', 'slug' => 'el-napoles-festeja-y-va-directo-a-la-final-de-la-copa', 'summary' => $summary, 'content' => $content, 'video' => 'https://www.youtube.com/watch?v=Y-NeVAOkMlI', 'featured' => '1', 'comment' => '1', 'state' => '1', 'user_id' => 1, 'created_at' => Carbon\Carbon::create(2020, 07, 03)],
        	['id' => 4, 'image' => 'noticia4de5.png', 'title' => 'Un gol que lo cambio todo...', 'slug' => 'un-gol-que-lo-cambio-todo', 'summary' => $summary, 'content' => $content, 'video' => 'https://www.youtube.com/watch?v=Y-NeVAOkMlI', 'featured' => '1', 'comment' => '1', 'state' => '1', 'user_id' => 1, 'created_at' => Carbon\Carbon::create(2020, 07, 03)],
        	...
        	['id' => 6, 'image' => 'noticiadestacada4de4.png', 'title' => 'Siete curiosidades del estadio Alfredo Di Stéfano', 'slug' => 'siete-curiosidades-del-estadio-alfredo-di-stefano', 'summary' => $summary, 'content' => $content, 'video' => 'https://www.youtube.com/watch?v=Y-NeVAOkMlI', 'featured' => '2', 'comment' => '1', 'state' => '1', 'user_id' => 1, 'created_at' => Carbon\Carbon::create(2020, 07, 04)],
        	...
        	['id' => 8, 'image' => 'noticiadestacada2de4.png', 'title' => 'Mallorca derrota 1 a 0 a Barcelona', 'slug' => 'mallorca-derrota-1-a-0-a-barcelona', 'summary' => $summary, 'content' => $content, 'video' => 'https://www.youtube.com/watch?v=Y-NeVAOkMlI', 'featured' => '2', 'comment' => '1', 'state' => '1', 'user_id' => 1, 'created_at' => Carbon\Carbon::create(2020, 07, 04)],
