							...
							<div class="col-12">
								...
								<div class="row match" match="{{ $match->slug }}">
									...
									<div class="col-lg-4 col-md-4 col-sm-4 col-12">
										<p class="h6 text-black py-2 mb-3">{{ date('d-m-Y h:i a', strtotime($match->date)) }}</p>
									</div>
									...
									<div class="col-lg-3 col-md-2 col-12">
										<p class="h6 text-black d-flex justify-content-between">
											<span class="pr-1 py-2">{{ $match->teams[0]->name }}</span>
											<img src="{{ asset('/admins/img/teams/'.$match->teams[0]->shield) }}" width="50" height="50" class="rounded-circle" alt="{{ $match->teams[0]->name }}">
										</p>
									</div>
									...
									<div class="col-lg-6 col-md-8 col-12">
										<div class="row">
											<div class="col-lg-5 col-md-5 col-sm-5 col-12">
												<input type="text" class="form-control goals" value="@if(is_null($match->teams[0]->pivot->goals)){{ "" }}@else{{ $match->teams[0]->pivot->goals }}@endif" min="0" match="{{ $match->slug }}" team="0">
											</div>
											...
											<div class="col-lg-5 col-md-5 col-sm-5 col-12">
												<p class="h6 text-black text-right">
													<input type="text" class="form-control goals" value="@if(is_null($match->teams[1]->pivot->goals)){{ "" }}@else{{ $match->teams[1]->pivot->goals }}@endif" min="0" match="{{ $match->slug }}" team="1" >
												</p>
											</div>
										</div>
									</div>
									...
									<div class="col-lg-3 col-md-2 col-12">
										<p class="h6 text-black text-right d-flex justify-content-between">
											<img src="{{ asset('/admins/img/teams/'.$match->teams[1]->shield) }}" width="50" height="50" class="rounded-circle" alt="{{ $match->teams[0]->name }}">
											<span class="pl-1 py-2">{{ $match->teams[1]->name }}</span>
										</p>
									</div>
