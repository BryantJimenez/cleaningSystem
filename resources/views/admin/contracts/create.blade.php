			...
			<div class="widget-content widget-content-area">
				...
				<div class="row">
					<div class="col-12">
						...
						<form action="{{ route('contratos.store') }}" method="POST" class="form" id="formcontrato" enctype="multipart/form-data">
							@csrf
							<div class="row">
								...
								<div class="form-group col-lg-6 col-md-6 col-12">
									...
									<input class="form-control" type="text" name="price" required placeholder="Introduzca un un precio" value="{{ old('price') }}">
								</div>
