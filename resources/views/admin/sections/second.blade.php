								...
								<div class="form-group col-lg-12 col-md-12 col-12">
									<div class="row">
										<div class="form-group col-lg-12 col-md-12 col-12">
											...
											<textarea class="form-control @error('about') is-invalid @enderror" name="about" placeholder="Introduce el texto de la sección de quienes somos" id="content-about" rows="5">{!! $section->about !!}</textarea>
										</div>
										<div class="form-group col-lg-12 col-md-12 col-12">
											<label class="col-form-label">Servicios<b class="text-danger">*</b></label>
											<input class="form-control" type="text" name="services" required placeholder="Introduzca un servicio" value="{{ $section->services }}">
										</div>
									</div> 
								</div>
