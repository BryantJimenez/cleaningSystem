			...
			<div class="widget-header">
				<div class="row">
					...
					<div class="col-xl-12 col-md-12 col-sm-12 col-12 ">
						<h4>PASO 6: INGRESE FOTOS DE LA VIVIENDA
						</h4>
					</div> 
				</div>
			</div>
				...
				<div class="col-12">
					...
					<form  method="POST" class="form" id="formbanco" enctype="multipart/form-data">
						...
						<div class="row">
									...
									<div class="form-group col-lg-6 col-md-6 col-12" id="click">
										<div class="row" >
											<div class="form-group col-lg-12 col-md-12 col-12">
												...
												<textarea class="form-control" name="">Introduzca una descripcion</textarea>
											</div>
											<div class="form-group col-lg-12 col-md-12 col-12">
							...
							<p class="lead mt-5">
								<a class="btn btn-success" href="{{route('admin')}}" role="button">Siguiente -></a>
							</p>
