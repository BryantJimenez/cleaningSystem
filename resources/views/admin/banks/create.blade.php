			...
			<div class="widget-content widget-content-area">
				...
				<div class="row">
					<div class="col-12">
						...
						<form action="{{ route('bancos.store') }}" method="POST" class="form" id="formCategoria" enctype="multipart/form-data">
							@csrf
							...
							<div class="row">
								...
								<div class="form-group col-lg-12 col-md-12 col-12">
									...
									<input class="form-control" type="text" name="code" required placeholder="Introduzca un código" value="{{ old('name') }}">
								</div>
