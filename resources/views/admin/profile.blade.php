		...
		<div class="col-xl-4 col-lg-6 col-md-5 col-sm-12 layout-top-spacing">
			...
			<div class="work-experience layout-spacing ">
				...
				<div class="widget-content widget-content-area">
					...
					<h3 class=""><a href="{{ route('mis.servicios') }}">Ultimos Servicios Realizados</a></h3>
		...
		<div class="col-xl-8 col-lg-6 col-md-7 col-sm-12 layout-top-spacing">
			...
			<div class="bio layout-spacing ">
				<div class="widget-content widget-content-area">
					...
					<p>Visualiza todas y cada una de tus viviendas adquiridas, y/o alquiladas</p>
					...
					<div class="bio-skill-box">
						...
						<div class="row">
							...
							<div class="col-12 col-xl-6 col-lg-12 mb-xl-5 mb-5 ">
								<a href="{{ route('mis.viviendas') }}">
									<div class="d-flex b-skills">
										<div></div>
										<div class="">
											<h5>Titulo de La Propiedad</h5>
											<p>Descripcion</p>
											<h6>Estado de La Propiedad</h6>
										</div>
									</div>
								</a>
							</div>
