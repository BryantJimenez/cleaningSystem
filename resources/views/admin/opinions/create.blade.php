 			...
 			<div class="widget-content widget-content-area">
 				...
 				<div class="row">
 					<div class="col-12">
 						...
 						<form action="{{ route('opiniones.store') }}" method="POST" class="form" id="formOpiniones" enctype="multipart/form-data">
 							@csrf
 							<div class="row">
 								...
 								<div class="form-group col-lg-6 col-md-6 col-12">
 									<div class="row">
 										...
 										<div class="form-group col-lg-12 col-md-12 col-12">
 											...
 											<input class="form-control" type="text" name="position" required placeholder="Introduzca una ocupación" value="{{ old('position') }}">
 										</div>
 									</div> 
 								</div>
 								...
 								<div class="form-group col-lg-12 col-md-12 col-12">
 									...
 									<textarea class="form-control @error('opinion') is-invalid @enderror" name="opinion" placeholder="Introduce el texto de su opinion" id="content-opinion" rows="5"></textarea>
 								</div>
