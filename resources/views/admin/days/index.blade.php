							...
							<div class="col-12 days" day="{{ $day->slug }}">
								...
								<div class="row match" match="{{ $match->slug }}">
									<div class="col-lg-3 col-md-3 col-sm-6 col-12">
										<p class="h6 text-black">{{ date('d-m-Y h:i a', strtotime($match->date)) }}</p>
									</div>

									<div class="col-lg-5 col-md-5 col-sm-6 col-12">
										<p class="h6 text-black text-lg-center">{{ $match->teams[0]->name }} <b class="text-danger">VS</b> {{ $match->teams[1]->name }}</p>
									</div>
