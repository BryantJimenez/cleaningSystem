		...
		<div class="row mb-5">
			<div class="col-md">
				<div class="ftco-footer-widget mb-4">
					<h2 class="ftco-heading-2">Cuidamos tu casa</h2>
					<p>El grupo Urbaniza XXI ofrece todos los servicios necesarios para la satisfación de nuestros clientes: asesoramiento jurídico, administración de fincas, gestión...</p>
			...
			<div class="col-md">
				<div class="ftco-footer-widget mb-4 ml-md-4">
					...
					<ul class="list-unstyled">
						...
						<li><a href="#"><span class="icon-long-arrow-right mr-2"></span>Opiniones</a></li>
						<li><a href="#"><span class="icon-long-arrow-right mr-2"></span>Viviendas</a></li>
			...
			<div class="col-md">
				<div class="ftco-footer-widget mb-4">
					...
					<ul class="list-unstyled">
						<li><a href="{{ route('legal') }}"><span class="icon-long-arrow-right mr-2"></span>Aviso Legal</a></li>
					</ul>
				</div>
			</div>
			<div class="col-md">
		...
		<div class="row">
			<div class="col-md-12 text-center">
				...
				<p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
					Copyright &copy;<script>document.write(new Date().getFullYear());</script> Todos los derechos reservados | Realizado Por OttersCompany <i class="icon-heart color-danger" aria-hidden="true"></i>
