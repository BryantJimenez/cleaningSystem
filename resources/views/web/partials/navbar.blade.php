	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" >
			<ul class="navbar-nav nav ml-auto">
				...
				<li class="nav-item cta"><a href="#" class="nav-link" data-toggle="modal" data-target="#exampleModal">¡Bienvenido!</a></li>
				@else
				...
				<li class="nav-item cta"><a href="#" class="nav-link">{{ Auth::user()->name." ".Auth::user()->lastname }}</a></li>
				@endguest
