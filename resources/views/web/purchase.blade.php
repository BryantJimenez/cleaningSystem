  ...
  <div class="container">
    <div class="row no-gutters slider-text align-items-end justify-content-center">
      <div class="col-md-9 ftco-animate pb-5 text-center">
        <h1 class="mb-3 bread">Compra de Vivienda</h1>
        <p class="breadcrumbs"><span class="mr-2"><a href="">Inicio <i class="ion-ios-arrow-forward"></i></a></span> <span class="mr-2"><a href="">Vivienda <i class="ion-ios-arrow-forward"></i></a></span> <span>Compra de Vivienda <i class="ion-ios-arrow-forward"></i></span></p>
      </div>
    </div>
  </div>
</section>
...
<section class="ftco-counter img ftco-section ftco-no-pt ftco-no-pb" id="section-counter" data-section="about">
  ...
  <h1 class="text-center">Compra de Vivienda</h1>
          ...
          <form action="#" class="bg-light p-5 contact-form">
            ...
            <div class="row">
              ...
              <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" disabled placeholder="500$">
              </div>
              <div class="form-group col-md-6">
